...
public:
    ...
    void setupUi(QDialog *BDFormulaireDeLocal)
    {
        if (BDFormulaireDeLocal->objectName().isEmpty())
            BDFormulaireDeLocal->setObjectName(QStringLiteral("BDFormulaireDeLocal"));
        ...
        comboBoxTypeUtil->setObjectName(QStringLiteral("comboBoxTypeUtil"));
        ...
        comboBoxTypeLocal->setObjectName(QStringLiteral("comboBoxTypeLocal"));
        ...
        spinBoxPEstimee->setObjectName(QStringLiteral("spinBoxPEstimee"));
        ...
        doubleSpinBoxSuperficie->setObjectName(QStringLiteral("doubleSpinBoxSuperficie"));
    ...
    {
        BDFormulaireDeLocal->setWindowTitle(QApplication::translate("BDFormulaireDeLocal", "Dialog", 0));
        groupBox_2->setTitle(QApplication::translate("BDFormulaireDeLocal", "Caract\303\251ristiques", 0));
        label_7->setText(QApplication::translate("BDFormulaireDeLocal", "D\303\251signation: ", 0));
        label->setText(QApplication::translate("BDFormulaireDeLocal", "Type d'utilisation: ", 0));
        label_2->setText(QApplication::translate("BDFormulaireDeLocal", "Type de local:", 0));
        groupBox->setTitle(QApplication::translate("BDFormulaireDeLocal", "Puissance estim\303\251e", 0));
        label_3->setText(QApplication::translate("BDFormulaireDeLocal", "Puissance estim\303\251e:", 0));
        label_4->setText(QApplication::translate("BDFormulaireDeLocal", "VA/m\302\262", 0));
        label_5->setText(QApplication::translate("BDFormulaireDeLocal", "Superficie:", 0));
        label_6->setText(QApplication::translate("BDFormulaireDeLocal", "m\302\262", 0));
        btn_Annuler->setText(QApplication::translate("BDFormulaireDeLocal", "Annuler", 0));
        btn_OK->setText(QApplication::translate("BDFormulaireDeLocal", "OK", 0));
    } // retranslateUi
