...
#define NCREPORTAPP_VERSION		"2.10.0"
#ifdef NCREPORT_EVAL
    #define NCREPORTAPP_RELEASENAME	"Eval version"
#else
    #define NCREPORTAPP_RELEASENAME	""
#endif
#define NCREPORTAPP_RELEASEDATE	"2013-07-15"
#define NCREPORTAPP_COPYRIGHT	QString("%1 2006-2013 NociSoft/Helta Kft.").arg(QChar(Qt::Key_copyright))
